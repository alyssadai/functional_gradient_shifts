...
# Description: # Description: Compares two independent groups using the shift function. Used to compare component gradient values from adult and child gradient maps, or adult and adolescent gradient maps.
# Example usage: ./run_shiftfn_indgrps_singlecomp.R 2 adults children
...
# Load data -----
comp_data <- read_csv(paste0("inputs/",dirname,"c",comp,"_grps_gradient_na-rm_long.csv"), col_names=T, col_types="fd")
...
set.seed(4)
sf <- shifthd_pbci(data = comp_data,
                   formula = obs ~ gr,
